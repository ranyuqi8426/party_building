...
//	 * 查询总数
//	 */
//	public int listCount(HappyPartyVO HappyPartyVO) {
//		String sql = "select count(*) from pay_merchant_account where 1=1 ";
...
//	}
	...
	public List<HappyParty> list(HappyPartyVO HappyPartyVO) {
		String sql = "select * from t_data_activity t where 1=1 and statue != '2' and type = '1' and audit_status= '1'";
		sql += createSearchSql(HappyPartyVO);
	...
	public HashMap<String,Object> listMe(HappyPartyVO HappyPartyVO) {
		String sql = "select * from t_user_activity t,t_data_activity a where 1=1 and t.activity_id=a.activity_id and a.type = '1' and t.user_type= '1' and user_id = :uid";
		sql += createSearchSql(HappyPartyVO);
		...
		SqlParameterSource paramSource = new BeanPropertySqlParameterSource(HappyPartyVO);
		List<HappyParty> list = namedParameterJdbcTemplate.query(sql, paramSource, new BeanPropertyRowMapper(HappyParty.class));
		String sql2 = "select * from t_user_activity t,t_data_activity a where 1=1 and t.activity_id=a.activity_id and a.type = '1' and t.user_type= '2' and user_id = :uid";
...
//		String sql = "update pay_merchant_account set merchant_id=:merchant_id,alpay_user_id=:alpay_user_id,bank_id=:bank_id,app_auth_token=:app_auth_token,auth_app_id=:auth_app_id,expires_in=:expires_in,re_expires_in=:re_expires_in,app_refresh_token=:app_refresh_token where account_id=:account_id";
//		NamedParameterJdbcTemplate namedParameterJdbcTemplate = new NamedParameterJdbcTemplate(jdbcTemplate);
//		SqlParameterSource paramSource = new BeanPropertySqlParameterSource(HappyParty);
//		return namedParameterJdbcTemplate.update(sql, paramSource);
//	}
...
//		String sql = "delete from pay_merchant_account where account_id=? ";
