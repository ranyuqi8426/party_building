...
public class SysDwDao {
	...
	public List<ComboboxVO> getComboboxTree(String dwid) {
		String strSql = "select t.dwid as value,t.dwmc as content from es_sys_dw t order by t.dwid  ";
		if(null!=dwid&&dwid!="null"){
			strSql = "select t.dwid as value,t.dwmc as content from es_sys_dw t where t.dwid='"+dwid+"' order by t.dwid  ";			
		}
