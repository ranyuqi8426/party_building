...
import com.app.sys.model.SysRoleModule;
...
public class SysRoleDao {
	...
	public int add(SysRole sysRole) {
		...
		String sql = "insert into t_sys_role(name,code,description,display_order,is_admin,default_module)"
				+ " values(:name,:code,:description,:display_order,:is_admin,:default_module)";
